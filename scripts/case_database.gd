...
static func case_001() -> Dictionary:
	return {
		...
		"evidence": [
			{"id":"coffee","name":"Coffee Cup","detail":"A half-finished coffee sits beside the victim. A faint bitter residue lines the bottom.","category":"FORENSIC","points":20},
			{"id":"spare_key","name":"Spare Key","detail":"A spare apartment key is hidden behind a loose picture frame. It explains access without forced entry.","category":"ACCESS","points":20},
			{"id":"ledger","name":"Property Ledger","detail":"Several transfers are marked with initials E.C. and do not appear in the company account.","category":"MOTIVE","points":20},
			{"id":"pharmacy_receipt","name":"Pharmacy Receipt","detail":"A receipt from 19:12 shows a purchase of a substance that can produce the residue found in the coffee.","category":"FORENSIC","points":20},
			{"id":"phone_message","name":"Deleted Phone Message","detail":"Recovered draft: Daniel wrote, 'Evelyn, we need to talk about the missing funds tonight.'","category":"MOTIVE","points":20},
			{"id":"watch","name":"Broken Watch","detail":"The victim's watch stopped at 21:06. It is useful for the timeline but does not identify the killer.","category":"TIMELINE","points":5},
			{"id":"red_scarf","name":"Red Scarf","detail":"A scarf belonging to a visitor is found on a chair. It proves presence, not murder.","category":"DISTRACTION","points":5},
			{"id":"window","name":"Open Window","detail":"The window is open, but dust on the sill is undisturbed. It is a staged escape route.","category":"DISTRACTION","points":5}
		],
		"suspects": [
